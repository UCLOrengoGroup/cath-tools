...
score_value structal_score::do_calculate(const alignment &arg_alignment, ///< The pair alignment to be scored
...
/// \brief TODOCUMENT
bool structal_score::do_less_than_with_same_dynamic_type(const aligned_pair_score &arg_aligned_pair_score ///< TODOCUMENT
                                                         ) const {
...
/// \brief TODOCUMENT
score_value structal_score::score_for_target_length(const pair<coord_list_vec, coord_list_vec> &arg_common_coords_by_residue,  ///< TODOCUMENT
...
structal_score::structal_score(const common_residue_selection_policy &arg_comm_res_seln_pol, ///< The policy to use for selecting common residues
...
bool cath::score::operator<(const structal_score &arg_structal_score_a, ///< TODOCUMENT
                            const structal_score &arg_structal_score_b  ///< TODOCUMENT
                            ) {
	auto the_helper = make_less_than_helper( arg_structal_score_a, arg_structal_score_b );
