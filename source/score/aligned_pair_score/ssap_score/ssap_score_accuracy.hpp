...
#ifndef _CATH_TOOLS_SOURCE_SCORE_ALIGNED_PAIR_SCORE_SSAP_SCORE_SSAP_SCORE_ACCURACY_H
#define _CATH_TOOLS_SOURCE_SCORE_ALIGNED_PAIR_SCORE_SSAP_SCORE_SSAP_SCORE_ACCURACY_H
