/// \file
/// \brief The geometric_mean_length_getter class header
...
#ifndef _CATH_TOOLS_SOURCE_SCORE_LENGTH_GETTER_GEOMETRIC_MEAN_LENGTH_GETTER_H
#define _CATH_TOOLS_SOURCE_SCORE_LENGTH_GETTER_GEOMETRIC_MEAN_LENGTH_GETTER_H
...
namespace cath {
	namespace score {
		...
		public:
			virtual ~geometric_mean_length_getter() noexcept = default;
		};
