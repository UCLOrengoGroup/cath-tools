...
#ifndef _CATH_TOOLS_SOURCE_SCORE_LENGTH_GETTER_LENGTH_OF_SECOND_GETTER_H
#define _CATH_TOOLS_SOURCE_SCORE_LENGTH_GETTER_LENGTH_OF_SECOND_GETTER_H
...
namespace cath {
	namespace score {
		...
		public:
			virtual ~length_of_second_getter() noexcept = default;
		};
