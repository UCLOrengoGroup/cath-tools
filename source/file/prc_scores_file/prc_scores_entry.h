...
namespace cath {
	namespace file {
		...
		public:
			...
			size_t      get_start_1() const;
			size_t      get_end_1() const;
			size_t      get_length_1() const;
			size_t      get_hit_num() const;
			std::string get_name_2() const;
			size_t      get_start_2() const;
			size_t      get_end_2() const;
			size_t      get_length_2() const;
			double      get_simple() const;
			double      get_reverse() const;
