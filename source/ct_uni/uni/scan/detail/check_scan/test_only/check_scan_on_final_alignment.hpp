...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_CHECK_SCAN_TEST_ONLY_CHECK_SCAN_ON_FINAL_ALIGNMENT_HPP
#define _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_CHECK_SCAN_TEST_ONLY_CHECK_SCAN_ON_FINAL_ALIGNMENT_HPP
