...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_SCAN_INDEX_STORE_SCAN_INDEX_LATTICE_STORE_HPP
#define _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_SCAN_INDEX_STORE_SCAN_INDEX_LATTICE_STORE_HPP
