...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_HOMCHECK_TOOLS_SUPERFAMILY_OF_DOMAIN_HPP
#define _CATH_TOOLS_SOURCE_UNI_SCORE_HOMCHECK_TOOLS_SUPERFAMILY_OF_DOMAIN_HPP
