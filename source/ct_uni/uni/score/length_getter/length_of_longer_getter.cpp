...
#include "length_of_longer_getter.hpp"
...
/// \brief TODOCUMENT
size_t length_of_longer_getter::do_get_length(const protein   &prm_protein_a,     ///< TODOCUMENT
...
/// \brief TODOCUMENT
bool length_of_longer_getter::do_less_than_with_same_dynamic_type(const length_getter &/*prm_length_getter*/ ///< TODOCUMENT
                                                                   ) const {
	return false;
}
