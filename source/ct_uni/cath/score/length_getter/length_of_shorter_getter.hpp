...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_LENGTH_OF_SHORTER_GETTER_HPP
#define _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_LENGTH_OF_SHORTER_GETTER_HPP
