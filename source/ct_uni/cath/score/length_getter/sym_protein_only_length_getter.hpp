...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_LENGTH_GETTER_SYM_PROTEIN_ONLY_LENGTH_GETTER_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_LENGTH_GETTER_SYM_PROTEIN_ONLY_LENGTH_GETTER_HPP
