/// \file
/// \brief The mean_length_getter class header
...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_LENGTH_GETTER_MEAN_LENGTH_GETTER_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_LENGTH_GETTER_MEAN_LENGTH_GETTER_HPP
...
namespace cath {
	namespace score {
		...
		/// \brief TODOCUMENT
		class mean_length_getter final : public sym_protein_only_length_getter {
		  private:
...
#endif // _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_LENGTH_GETTER_MEAN_LENGTH_GETTER_HPP
