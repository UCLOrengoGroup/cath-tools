...
#ifndef CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_HOMCHECK_TOOLS_SSAPS_AND_PRCS_OF_QUERY_HPP
#define CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_HOMCHECK_TOOLS_SSAPS_AND_PRCS_OF_QUERY_HPP
...
namespace cath::file { using prc_scores_entry_vec = std::vector<prc_scores_entry>; }
namespace cath::file { using ssap_scores_entry_vec = std::vector<ssap_scores_entry>; }
namespace cath::homcheck { class ssap_and_prc; }
namespace cath::homcheck { class superfamily_of_domain; }
...
#endif // CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_HOMCHECK_TOOLS_SSAPS_AND_PRCS_OF_QUERY_HPP
