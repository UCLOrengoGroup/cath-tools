...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_SCORE_CLASSIFICATION_SCORE_CLASSN_VALUE_BETTER_VALUE_HPP
#define _CATH_TOOLS_SOURCE_UNI_SCORE_SCORE_CLASSIFICATION_SCORE_CLASSN_VALUE_BETTER_VALUE_HPP
