/// \file
/// \brief The mi_score class header
...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_MI_SCORE_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_MI_SCORE_HPP
...
namespace cath::score {
	...
	class mi_score : public  aligned_pair_score {
	private:
...
//			ar & BOOST_SERIALIZATION_NVP( full_length_getter_ptr );
//		}
	  ...
	  public:
		mi_score() = default;
		explicit mi_score(const sym_protein_only_length_getter &);
	...
	bool operator<(const mi_score &,
	               const mi_score &);

} // namespace cath::score

#endif // _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_MI_SCORE_HPP
