...
#ifndef CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_SSAP_SCORE_HPP
#define CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_SSAP_SCORE_HPP
...
namespace cath::score {
	...
	private:
	  ...
	  public:
		...
		[[nodiscard]] const ssap_score_post_processing &get_post_processing() const;
		[[nodiscard]] const ssap_score_accuracy &       get_accuracy() const;
		[[nodiscard]] const size_t &                    get_num_excluded_on_sides() const;
...
#endif // CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_SSAP_SCORE_HPP
