...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_SSAP_SCORE_SSAP_SCORE_POST_PROCESSING_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_SSAP_SCORE_SSAP_SCORE_POST_PROCESSING_HPP
...
namespace cath::score {
	...
	/// \brief TODOCUMENT
	inline constexpr size_t num_ssap_score_post_processings = std::tuple_size_v< decltype( all_ssap_score_post_processings ) >;
...
#endif // _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_SSAP_SCORE_SSAP_SCORE_POST_PROCESSING_HPP
