...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_LIST_DETAIL_ALIGNED_PAIR_SCORE_LIST_APPEND_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_LIST_DETAIL_ALIGNED_PAIR_SCORE_LIST_APPEND_HPP
...
namespace cath { namespace score { class aligned_pair_score_list; } }
namespace cath { namespace score { class drmsd_score; } }
namespace cath { namespace score { class gsas_score; } }
namespace cath { namespace score { class length_getter; } }
namespace cath { namespace score { class length_score; } }
namespace cath { namespace score { class lddt_score; } }
namespace cath { namespace score { class mi_score; } }
namespace cath { namespace score { class rmsd_score; } }
namespace cath { namespace score { class sas_score; } }
namespace cath { namespace score { class sequence_similarity_score; } }
namespace cath { namespace score { class si_score; } }
namespace cath { namespace score { class ssap_score; } }
...
#endif // _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCORE_ALIGNED_PAIR_SCORE_LIST_DETAIL_ALIGNED_PAIR_SCORE_LIST_APPEND_HPP
