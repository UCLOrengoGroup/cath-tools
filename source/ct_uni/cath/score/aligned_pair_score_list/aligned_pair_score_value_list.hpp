...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_ALIGNED_PAIR_SCORE_LIST_ALIGNED_PAIR_SCORE_VALUE_LIST_HPP
#define _CATH_TOOLS_SOURCE_UNI_SCORE_ALIGNED_PAIR_SCORE_LIST_ALIGNED_PAIR_SCORE_VALUE_LIST_HPP
