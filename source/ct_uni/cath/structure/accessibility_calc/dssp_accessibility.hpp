...
#ifndef _CATH_TOOLS_SOURCE_UNI_STRUCTURE_ACCESSIBILITY_CALC_DSSP_ACCESSIBILITY_HPP
#define _CATH_TOOLS_SOURCE_UNI_STRUCTURE_ACCESSIBILITY_CALC_DSSP_ACCESSIBILITY_HPP
...
namespace cath { namespace file { enum class coarse_element_type : char; } }
