...
#ifndef CATH_TOOLS_SOURCE_CT_UNI_CATH_STRUCTURE_VIEW_CACHE_INDEX_DETAIL_DIMS_DETAIL_VIEW_CACHE_INDEX_DIM_LINEAR_HPP
#define CATH_TOOLS_SOURCE_CT_UNI_CATH_STRUCTURE_VIEW_CACHE_INDEX_DETAIL_DIMS_DETAIL_VIEW_CACHE_INDEX_DIM_LINEAR_HPP
		...
		if constexpr ( common::IS_IN_DEBUG_MODE ) {
			if ( prm_cells.empty() ) {
				BOOST_THROW_EXCEPTION(
				  cath::common::invalid_argument_exception( "Cannot get entry at_value() with no populated cells" ) );
			}
			if ( !has_cell_at_value( prm_cells, prm_value ) ) {
				BOOST_THROW_EXCEPTION(
				  cath::common::invalid_argument_exception( "Value is not found in any of the cells" ) );
			}
		}
...
#endif // CATH_TOOLS_SOURCE_CT_UNI_CATH_STRUCTURE_VIEW_CACHE_INDEX_DETAIL_DIMS_DETAIL_VIEW_CACHE_INDEX_DIM_LINEAR_HPP
