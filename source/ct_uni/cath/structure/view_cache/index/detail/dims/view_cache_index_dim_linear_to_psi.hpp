...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_STRUCTURE_VIEW_CACHE_INDEX_DETAIL_DIMS_VIEW_CACHE_INDEX_DIM_LINEAR_TO_PSI_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_STRUCTURE_VIEW_CACHE_INDEX_DETAIL_DIMS_VIEW_CACHE_INDEX_DIM_LINEAR_TO_PSI_HPP
	...
	namespace detail {
		...
		struct vci_linear_view_to_psi_getter final {
			...
			auto operator()(const view_cache_index_entry &prm_entry ///< TODOCUMENT
			                )->decltype( prm_entry.get_to_psi_angle() ) {
				return prm_entry.get_to_psi_angle();
			}
...
#endif // _CATH_TOOLS_SOURCE_CT_UNI_CATH_STRUCTURE_VIEW_CACHE_INDEX_DETAIL_DIMS_VIEW_CACHE_INDEX_DIM_LINEAR_TO_PSI_HPP
