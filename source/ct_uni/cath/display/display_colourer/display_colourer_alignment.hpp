...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_DISPLAY_DISPLAY_COLOURER_DISPLAY_COLOURER_ALIGNMENT_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_DISPLAY_DISPLAY_COLOURER_DISPLAY_COLOURER_ALIGNMENT_HPP
...
namespace cath {
	...
	class display_colourer_alignment final : public display_colourer {
	private:
...
#endif // _CATH_TOOLS_SOURCE_CT_UNI_CATH_DISPLAY_DISPLAY_COLOURER_DISPLAY_COLOURER_ALIGNMENT_HPP
