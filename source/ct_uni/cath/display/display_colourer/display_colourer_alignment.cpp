...
display_colour_spec display_colourer_alignment::do_get_colour_spec(const alignment_context &prm_alignment_context ///< The alignment_context to gradient-colour
                                                                   ) const {
...
/// \brief Ctor
display_colourer_alignment::display_colourer_alignment(display_colour_gradient prm_gradient ///< The gradient with which this display_colourer_alignment should colour alignments
