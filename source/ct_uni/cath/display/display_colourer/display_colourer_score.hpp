...
#ifndef _CATH_TOOLS_SOURCE_UNI_DISPLAY_DISPLAY_COLOURER_DISPLAY_COLOURER_SCORE_HPP
#define _CATH_TOOLS_SOURCE_UNI_DISPLAY_DISPLAY_COLOURER_DISPLAY_COLOURER_SCORE_HPP
