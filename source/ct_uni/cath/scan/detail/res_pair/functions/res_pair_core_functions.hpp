...
#ifndef _CATH_TOOLS_SOURCE_SCAN_DETAIL_RES_PAIR_FUNCTIONS_RES_PAIR_CORE_FUNCTIONS_H
#define _CATH_TOOLS_SOURCE_SCAN_DETAIL_RES_PAIR_FUNCTIONS_RES_PAIR_CORE_FUNCTIONS_H
