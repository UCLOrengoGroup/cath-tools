/// \file
/// \brief The residue index pair functions header
...
///
/// This contains functions that are equivalent to the many of the non-member res_pair functions
/// but taking protein and size_size_pair arguments rather than res_pair arguments.
///
...
#ifndef CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_DETAIL_RES_PAIR_FUNCTIONS_RES_INDEX_PAIR_FUNCTIONS_HPP
#define CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_DETAIL_RES_PAIR_FUNCTIONS_RES_INDEX_PAIR_FUNCTIONS_HPP
...
#endif // CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_DETAIL_RES_PAIR_FUNCTIONS_RES_INDEX_PAIR_FUNCTIONS_HPP
