...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_SCAN_INDEX_STORE_DETAIL_HASH_TUPLE_HPP
#define _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_SCAN_INDEX_STORE_DETAIL_HASH_TUPLE_HPP
