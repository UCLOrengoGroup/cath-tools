...
#ifndef CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_DETAIL_SCAN_TYPE_ALIASES_HPP
#define CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_DETAIL_SCAN_TYPE_ALIASES_HPP
...
namespace cath::scan::detail { class multi_struc_res_rep_pair_list; }
namespace cath::scan::detail { class scan_structure_data; }
namespace cath::scan::detail { class single_struc_res_pair; }
namespace cath::scan::detail { class single_struc_res_pair_list; }
// clang-format on
...
#endif // CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_DETAIL_SCAN_TYPE_ALIASES_HPP
