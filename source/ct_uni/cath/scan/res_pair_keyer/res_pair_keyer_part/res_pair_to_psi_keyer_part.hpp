/// \file
/// \brief The res_pair_to_psi_keyer_part class header
...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_RES_PAIR_KEYER_RES_PAIR_KEYER_PART_RES_PAIR_TO_PSI_KEYER_PART_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_RES_PAIR_KEYER_RES_PAIR_KEYER_PART_RES_PAIR_TO_PSI_KEYER_PART_HPP
...
namespace cath::scan {
	...
	namespace detail {
		...
		/// \brief Specification for a res_pair_phi_psi_angle_keyer_part for the to_psi angle
		class res_pair_to_psi_keyer_part_spec final {
		public:
			...
			static angle_type get_value(const multi_struc_res_rep_pair &prm_res_pair ///< The res_pair from which the relevant value should be extracted
				...
				return prm_res_pair.get_res_pair_core().get_to_psi_angle();
			}
	...
	using res_pair_to_psi_keyer_part = detail::res_pair_phi_psi_angle_keyer_part<detail::res_pair_to_psi_keyer_part_spec>;

} // namespace cath::scan

#endif // _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_RES_PAIR_KEYER_RES_PAIR_KEYER_PART_RES_PAIR_TO_PSI_KEYER_PART_HPP
