...
#ifndef _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_RES_PAIR_KEYER_RES_PAIR_KEYER_PART_RES_PAIR_VIEW_X_KEYER_PART_HPP
#define _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_RES_PAIR_KEYER_RES_PAIR_KEYER_PART_RES_PAIR_VIEW_X_KEYER_PART_HPP
...
namespace cath::scan {
	...
	using res_pair_view_x_keyer_part = detail::axis_keyer_part<detail::res_pair_view_x_keyer_part_spec< detail::multi_struc_res_rep_pair, quad_criteria > >;

} // namespace cath::scan

#endif // _CATH_TOOLS_SOURCE_CT_UNI_CATH_SCAN_RES_PAIR_KEYER_RES_PAIR_KEYER_PART_RES_PAIR_VIEW_X_KEYER_PART_HPP
