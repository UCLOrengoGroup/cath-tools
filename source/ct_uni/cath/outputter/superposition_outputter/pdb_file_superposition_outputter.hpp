...
#ifndef CATH_TOOLS_SOURCE_CT_UNI_CATH_OUTPUTTER_SUPERPOSITION_OUTPUTTER_PDB_FILE_SUPERPOSITION_OUTPUTTER_HPP
#define CATH_TOOLS_SOURCE_CT_UNI_CATH_OUTPUTTER_SUPERPOSITION_OUTPUTTER_PDB_FILE_SUPERPOSITION_OUTPUTTER_HPP
...
namespace cath::opts {
	...
	private:
	  ...
	  public:
		pdb_file_superposition_outputter( ::std::filesystem::path, sup::superposition_content_spec );
	};

} // namespace cath::opts

#endif // CATH_TOOLS_SOURCE_CT_UNI_CATH_OUTPUTTER_SUPERPOSITION_OUTPUTTER_PDB_FILE_SUPERPOSITION_OUTPUTTER_HPP
