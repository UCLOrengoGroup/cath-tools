/// \file
/// \brief The pymol_view_superposition_outputter class header
...
#ifndef CATH_TOOLS_SOURCE_CT_UNI_CATH_OUTPUTTER_SUPERPOSITION_OUTPUTTER_PYMOL_VIEW_SUPERPOSITION_OUTPUTTER_HPP
#define CATH_TOOLS_SOURCE_CT_UNI_CATH_OUTPUTTER_SUPERPOSITION_OUTPUTTER_PYMOL_VIEW_SUPERPOSITION_OUTPUTTER_HPP
...
namespace cath::opts {
	...
	private:
	  ...
	  public:
		pymol_view_superposition_outputter( ::std::filesystem::path, display_spec, sup::superposition_content_spec );
	};

} // namespace cath::opts

#endif // CATH_TOOLS_SOURCE_CT_UNI_CATH_OUTPUTTER_SUPERPOSITION_OUTPUTTER_PYMOL_VIEW_SUPERPOSITION_OUTPUTTER_HPP
