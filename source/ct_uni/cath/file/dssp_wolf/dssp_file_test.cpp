...
namespace {
	...
	/// \brief TODOCUMENT
	path dssp_wolf_file_test_suite_fixture::wolf_file_of_example_id(const string &prm_example_id ///< TODOCUMENT
	                                                                      ) {
		return TEST_RESIDUE_IDS_DATA_DIR() / (prm_example_id + EXAMPLE_WOLF_FILE_SUFFIX);
	}

	/// \brief TODOCUMENT
	path dssp_wolf_file_test_suite_fixture::dssp_file_of_example_id(const string &prm_example_id ///< TODOCUMENT
	                                                                      ) {
		return TEST_RESIDUE_IDS_DATA_DIR() / (prm_example_id + EXAMPLE_DSSP_FILE_SUFFIX);
	}

	/// \brief TODOCUMENT
	path dssp_wolf_file_test_suite_fixture::pdb_file_of_example_id(const string &prm_example_id ///< TODOCUMENT
	                                                                     ) {
		return TEST_RESIDUE_IDS_DATA_DIR() / (prm_example_id + EXAMPLE_PDB_FILE_SUFFIX);
	}

	/// \brief TODOCUMENT
	path dssp_wolf_file_test_suite_fixture::expected_wolf_phi_psi_of_example_id(const string &prm_example_id ///< TODOCUMENT
	                                                                                  ) {
		return TEST_RESIDUE_IDS_DATA_DIR() / (prm_example_id + EXPECTED_WOLF_PHI_PSI_SUFFIX);
	}

	/// \brief TODOCUMENT
	void dssp_wolf_file_test_suite_fixture::check_phi_psi_from_wolf_against_expected(const string &prm_example_id ///< TODOCUMENT
	                                                                                 ) {
	...
	void dssp_wolf_file_test_suite_fixture::compare_phi_psi_from_pdb_vs_dssp(const string &prm_example_id ///< TODOCUMENT
	                                                                         ) {
	...
	/// \brief TODOCUMENT
	void dssp_wolf_file_test_suite_fixture::check_pdb_and_dssp_built_protein(const string &prm_example_id ///< TODOCUMENT
	                                                                         ) {
		ostringstream build_prot_warn_stream;
		const auto the_pdb_file               = read_pdb_file (  pdb_file_of_example_id( prm_example_id ) );
		const auto the_dssp_file              = read_dssp_file( dssp_file_of_example_id( prm_example_id ) );
	...
	/// \brief TODOCUMENT
	void dssp_wolf_file_test_suite_fixture::compare_residue_frames_from_pdb_vs_wolf(const string &prm_example_id ///< TODOCUMENT
	                                                                                ) {
		ostringstream build_prot_warn_stream;
...
/// \brief TODOCUMENT
BOOST_FIXTURE_TEST_SUITE(dssp_wolf_file_test_suite, dssp_wolf_file_test_suite_fixture)
