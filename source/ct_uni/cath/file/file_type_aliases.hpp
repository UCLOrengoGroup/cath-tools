...
#ifndef CATH_TOOLS_SOURCE_CT_UNI_CATH_FILE_FILE_TYPE_ALIASES_HPP
#define CATH_TOOLS_SOURCE_CT_UNI_CATH_FILE_FILE_TYPE_ALIASES_HPP
...
namespace cath::file { class hmmer_scores_entry; }
...
namespace cath::file { enum class data_file : unsigned int; }
namespace cath::file { enum class residue_makeup : bool; }
// clang-format on
...
#endif // CATH_TOOLS_SOURCE_CT_UNI_CATH_FILE_FILE_TYPE_ALIASES_HPP
