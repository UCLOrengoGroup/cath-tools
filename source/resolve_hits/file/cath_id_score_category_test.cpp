...
BOOST_AUTO_TEST_CASE(ending_round_2_is_later_round) {
	const string id = "bob_round_2";
	BOOST_CHECK_EQUAL( cath_score_category_of_id( { id }, true  ), cath_id_score_category::LATER_ROUND );
	BOOST_CHECK_EQUAL( cath_score_category_of_id( { id }, false ), cath_id_score_category::NORMAL      );
}

BOOST_AUTO_TEST_CASE(ending_round_74_is_later_round) {
...
BOOST_AUTO_TEST_CASE(id_1u5mA01_round_3_is_later_round) {
