...
#ifndef _CATH_TOOLS_SOURCE_RESOLVE_HITS_OPTIONS_SPEC_CRH_INPUT_SPEC_H
#define _CATH_TOOLS_SOURCE_RESOLVE_HITS_OPTIONS_SPEC_CRH_INPUT_SPEC_H

#include <boost/optional.hpp>

#include "common/path_type_aliases.hpp"
#include "resolve_hits/file/hits_input_format_tag.hpp"
...
namespace cath {
	namespace rslv {
		...
		private:
			...
			residx_t              min_gap_length         = DEFAULT_MIN_GAP_LENGTH;
		...
		public:
			...
			static constexpr residx_t              DEFAULT_MIN_GAP_LENGTH         = 30;
			...
			crh_input_spec & set_min_gap_length(const residx_t &);
