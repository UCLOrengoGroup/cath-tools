...
static_assert( means_output_trimmed_hits                 ( hit_boundary_output::TRIMMED ) == true,                         "" );
static_assert( means_output_trimmed_hits                 ( hit_boundary_output::ORIG    ) == false,                        "" );
