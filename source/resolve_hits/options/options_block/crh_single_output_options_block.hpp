...
#ifndef _CATH_TOOLS_SOURCE_RESOLVE_HITS_OPTIONS_OPTIONS_BLOCK_CRH_SINGLE_OUTPUT_OPTIONS_BLOCK_H
#define _CATH_TOOLS_SOURCE_RESOLVE_HITS_OPTIONS_OPTIONS_BLOCK_CRH_SINGLE_OUTPUT_OPTIONS_BLOCK_H
