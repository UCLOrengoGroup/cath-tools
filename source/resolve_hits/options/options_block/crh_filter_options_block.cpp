...
#include "crh_filter_options_block.h"
...
///        or none otherwise
opt_str crh_filter_options_block::do_invalid_string(const variables_map &/*arg_variables_map*/ ///< The variables map, which options_blocks can use to determine which options were specified, defaulted etc
                                                    ) const {
	return none;
}
