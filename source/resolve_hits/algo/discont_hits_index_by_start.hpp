...
#ifndef _CATH_TOOLS_SOURCE_RESOLVE_HITS_ALGO_DISCONT_HITS_INDEX_BY_START_HPP
#define _CATH_TOOLS_SOURCE_RESOLVE_HITS_ALGO_DISCONT_HITS_INDEX_BY_START_HPP
