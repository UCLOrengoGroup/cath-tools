...
#ifndef _CATH_TOOLS_SOURCE_RESOLVE_HITS_READ_AND_PROCESS_HITS_READ_AND_PROCESS_MGR_HPP
#define _CATH_TOOLS_SOURCE_RESOLVE_HITS_READ_AND_PROCESS_HITS_READ_AND_PROCESS_MGR_HPP
