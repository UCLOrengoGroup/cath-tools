...
namespace cath {
	...
	public:
		...
		static const size_t SEC_STRUC_A_VALUE;
		static const size_t SEC_STRUC_B_VALUE;
		static const size_t SEC_STRUC_MIN_SCORE_CUTOFF;
		static const size_t SEC_STRUC_MAX_DIST_SQ_CUTOFF;
	};
