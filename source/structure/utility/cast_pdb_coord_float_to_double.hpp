...
#ifndef _CATH_TOOLS_SOURCE_STRUCTURE_UTILITY_CAST_PDB_COORD_FLOAT_TO_DOUBLE_H
#define _CATH_TOOLS_SOURCE_STRUCTURE_UTILITY_CAST_PDB_COORD_FLOAT_TO_DOUBLE_H
