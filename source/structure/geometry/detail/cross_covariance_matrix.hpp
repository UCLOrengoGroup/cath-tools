...
#ifndef _CATH_TOOLS_SOURCE_STRUCTURE_GEOMETRY_DETAIL_CROSS_COVARIANCE_MATRIX_H
#define _CATH_TOOLS_SOURCE_STRUCTURE_GEOMETRY_DETAIL_CROSS_COVARIANCE_MATRIX_H
