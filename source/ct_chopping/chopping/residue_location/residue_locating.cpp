...
string cath::chop::to_string(const residue_locating &prm_residue_locating ///< The residue_locating to describe
                             ) {
	switch ( prm_residue_locating ) {
...
ostream & cath::chop::operator<<(ostream                &prm_os,              ///< The ostream into which the description should be inserted
                                 const residue_locating &prm_residue_locating ///< The residue_locating to describe
                                 ) {
	prm_os << to_string( prm_residue_locating );
	return prm_os;
}
