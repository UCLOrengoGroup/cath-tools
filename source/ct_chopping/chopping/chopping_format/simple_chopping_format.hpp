...
#ifndef _CATH_TOOLS_SOURCE_CHOPPING_CHOPPING_FORMAT_SIMPLE_CHOPPING_FORMAT_HPP
#define _CATH_TOOLS_SOURCE_CHOPPING_CHOPPING_FORMAT_SIMPLE_CHOPPING_FORMAT_HPP
