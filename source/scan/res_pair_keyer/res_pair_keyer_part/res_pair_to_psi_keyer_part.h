...
#ifndef _CATH_TOOLS_SOURCE_SCAN_RES_PAIR_KEYER_RES_PAIR_KEYER_PART_RES_PAIR_TO_PSI_KEYER_PART_H
#define _CATH_TOOLS_SOURCE_SCAN_RES_PAIR_KEYER_RES_PAIR_KEYER_PART_RES_PAIR_TO_PSI_KEYER_PART_H
...
#include "scan/res_pair_keyer/res_pair_keyer_part/detail/res_pair_phi_psi_angle_keyer_part.h"
		...
		namespace detail {
			...
			public:
				...
				static angle_type get_value(const multi_struc_res_rep_pair &arg_res_pair ///< The res_pair from which the relevant value should be extracted
					...
					return arg_res_pair.get_res_pair_core().get_to_psi_angle();
				}
