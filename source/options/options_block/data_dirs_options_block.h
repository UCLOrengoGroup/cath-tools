...
namespace cath {
	namespace opts {
		...
		public:
			...
			std::string get_path_of_data_file(const file::data_file &) const;
			std::string get_prefix_of_data_file(const file::data_file &) const;
			std::string get_suffix_of_data_file(const file::data_file &) const;
