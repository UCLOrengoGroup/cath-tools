...
#ifndef _CATH_TOOLS_SOURCE_OPTIONS_OPTIONS_BLOCK_CHECK_PDB_OPTIONS_BLOCK_HPP
#define _CATH_TOOLS_SOURCE_OPTIONS_OPTIONS_BLOCK_CHECK_PDB_OPTIONS_BLOCK_HPP
