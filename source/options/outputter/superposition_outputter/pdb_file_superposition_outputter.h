...
#ifndef PDB_FILE_SUPERPOSITION_OUTPUTTER_H_INCLUDED
#define PDB_FILE_SUPERPOSITION_OUTPUTTER_H_INCLUDED
...
namespace cath {
	namespace opts {
		...
		public:
			...
			virtual ~pdb_file_superposition_outputter() noexcept = default;
		};
