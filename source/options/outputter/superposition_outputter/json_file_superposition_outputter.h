...
#ifndef JSON_FILE_SUPERPOSITION_OUTPUTTER_H_INCLUDED
#define JSON_FILE_SUPERPOSITION_OUTPUTTER_H_INCLUDED
...
namespace cath {
	namespace opts {
		...
		public:
			...
			virtual ~json_file_superposition_outputter() noexcept = default;
