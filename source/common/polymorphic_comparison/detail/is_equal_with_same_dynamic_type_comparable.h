...
#ifndef _CATH_TOOLS_SOURCE_COMMON_POLYMORPHIC_COMPARISON_DETAIL_IS_EQUAL_WITH_SAME_DYNAMIC_TYPE_COMPARABLE_H
#define _CATH_TOOLS_SOURCE_COMMON_POLYMORPHIC_COMPARISON_DETAIL_IS_EQUAL_WITH_SAME_DYNAMIC_TYPE_COMPARABLE_H
