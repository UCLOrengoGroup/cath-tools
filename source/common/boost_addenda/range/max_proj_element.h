...
#ifndef _CATH_TOOLS_SOURCE_COMMON_BOOST_ADDENDA_RANGE_MAX_PROJ_ELEMENT_H
#define _CATH_TOOLS_SOURCE_COMMON_BOOST_ADDENDA_RANGE_MAX_PROJ_ELEMENT_H

#include <boost/range/algorithm/max_element.hpp>

#include "common/boost_addenda/range/range_concept_type_aliases.h"
#include "common/function/ident.h"
