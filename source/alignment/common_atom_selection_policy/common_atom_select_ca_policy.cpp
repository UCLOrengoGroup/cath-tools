/// \file
/// \brief The common_atom_select_ca_policy class definitions
...
string common_atom_select_ca_policy::do_get_descriptive_name() const {
	return "ca_atoms";
}

/// \brief A standard do_clone method.
unique_ptr<common_atom_selection_policy> common_atom_select_ca_policy::do_clone() const {
