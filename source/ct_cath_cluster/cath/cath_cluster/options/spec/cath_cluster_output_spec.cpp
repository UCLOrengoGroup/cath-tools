...
///
/// \relates cath_cluster_output_spec
str_view_opt cath::clust::has_output_requiring_single_level_clustering(const cath_cluster_output_spec &prm_output_spec ///< The cath_cluster_output_spec to query
                                                                       ) {
