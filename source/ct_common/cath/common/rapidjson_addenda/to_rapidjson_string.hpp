...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_RAPIDJSON_ADDENDA_TO_RAPIDJSON_STRING_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_RAPIDJSON_ADDENDA_TO_RAPIDJSON_STRING_H
