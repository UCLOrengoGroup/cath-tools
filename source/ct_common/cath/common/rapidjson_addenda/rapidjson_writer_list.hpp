...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_RAPIDJSON_ADDENDA_RAPIDJSON_WRITER_LIST_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_RAPIDJSON_ADDENDA_RAPIDJSON_WRITER_LIST_HPP
