...
#ifndef CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_TYPE_ALIASES_HPP
#define CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_TYPE_ALIASES_HPP
...
namespace cath {
	...
	using str_view_opt                  = ::std::optional<::std::string_view>;
...
#endif // CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_TYPE_ALIASES_HPP
