...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_EXCEPTION_INVALID_ARGUMENT_EXCEPTION_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_EXCEPTION_INVALID_ARGUMENT_EXCEPTION_HPP
