...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_EXCEPTION_OUT_OF_RANGE_EXCEPTION_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_EXCEPTION_OUT_OF_RANGE_EXCEPTION_HPP
