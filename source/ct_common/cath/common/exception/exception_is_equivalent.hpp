...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_EXCEPTION_EXCEPTION_IS_EQUIVALENT_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_EXCEPTION_EXCEPTION_IS_EQUIVALENT_HPP
