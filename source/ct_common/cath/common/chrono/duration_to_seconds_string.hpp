...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_CHRONO_DURATION_TO_SECONDS_STRING_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_CHRONO_DURATION_TO_SECONDS_STRING_HPP
