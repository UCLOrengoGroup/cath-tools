...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_TYPE_TRAITS_IS_TEMPLATE_OF_TYPE_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_TYPE_TRAITS_IS_TEMPLATE_OF_TYPE_HPP
