...
#ifndef CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_FILE_OPEN_FSTREAM_HPP
#define CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_FILE_OPEN_FSTREAM_HPP
...
#endif // CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_FILE_OPEN_FSTREAM_HPP
