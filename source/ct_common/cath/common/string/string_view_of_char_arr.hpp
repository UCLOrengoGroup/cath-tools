...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_STRING_STRING_VIEW_OF_CHAR_ARR_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_STRING_STRING_VIEW_OF_CHAR_ARR_HPP
