...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_ALGORITHM_IS_UNIQ_FOR_UNORDERED_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_ALGORITHM_IS_UNIQ_FOR_UNORDERED_HPP
