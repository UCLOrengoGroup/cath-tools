...
#ifndef CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_INVERT_PERMUTATION_HPP
#define CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_INVERT_PERMUTATION_HPP
...
#endif // CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_INVERT_PERMUTATION_HPP
