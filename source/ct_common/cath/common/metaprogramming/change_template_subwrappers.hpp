...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_METAPROGRAMMING_CHANGE_TEMPLATE_SUBWRAPPERS_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_METAPROGRAMMING_CHANGE_TEMPLATE_SUBWRAPPERS_HPP
