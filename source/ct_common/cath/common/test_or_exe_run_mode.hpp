...
#ifndef CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_TEST_OR_EXE_RUN_MODE_HPP
#define CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_TEST_OR_EXE_RUN_MODE_HPP
...
#endif // CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_TEST_OR_EXE_RUN_MODE_HPP
