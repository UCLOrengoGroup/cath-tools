...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_BOOST_ADDENDA_ITERATOR_ITERATOR_TRAITS_TYPE_ALIASES_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_BOOST_ADDENDA_ITERATOR_ITERATOR_TRAITS_TYPE_ALIASES_HPP
