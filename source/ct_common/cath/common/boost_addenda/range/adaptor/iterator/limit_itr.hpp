...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_BOOST_ADDENDA_RANGE_ADAPTOR_ITERATOR_LIMIT_ITR_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_BOOST_ADDENDA_RANGE_ADAPTOR_ITERATOR_LIMIT_ITR_HPP
...
// clang-format off
namespace cath::common { template <class RNG> class limit_itr; }
// clang-format on
...
#endif // _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_BOOST_ADDENDA_RANGE_ADAPTOR_ITERATOR_LIMIT_ITR_HPP
