...
#ifndef _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_BOOST_ADDENDA_PTR_CONTAINER_UNIQUE_PTR_FUNCTIONS_HPP
#define _CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_BOOST_ADDENDA_PTR_CONTAINER_UNIQUE_PTR_FUNCTIONS_HPP
