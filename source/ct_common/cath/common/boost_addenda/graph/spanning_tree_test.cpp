...
BOOST_AUTO_TEST_CASE(test_a) {
	const size_size_doub_tpl_vec input = {
		size_size_doub_tpl{  0,  5,  3.0 },
		size_size_doub_tpl{  1,  6,  7.0 },
		size_size_doub_tpl{  2,  6,  7.0 },
		size_size_doub_tpl{  3,  6, 10.0 },
		size_size_doub_tpl{  3,  9,  0.0 },
		size_size_doub_tpl{  4,  7,  1.0 },
		size_size_doub_tpl{  4,  8,  9.0 },
		size_size_doub_tpl{  4, 12,  9.0 },
		size_size_doub_tpl{  5,  7,  8.0 },
		size_size_doub_tpl{  7,  9,  6.0 },
		size_size_doub_tpl{  7, 10,  2.0 },
		size_size_doub_tpl{ 10, 11,  5.0 },
		size_size_doub_tpl{ 13,  9,  4.0 },
	};
