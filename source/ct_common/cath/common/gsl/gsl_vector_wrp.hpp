...
#ifndef CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_GSL_GSL_VECTOR_WRP_HPP
#define CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_GSL_GSL_VECTOR_WRP_HPP
...
#endif // CATH_TOOLS_SOURCE_CT_COMMON_CATH_COMMON_GSL_GSL_VECTOR_WRP_HPP
