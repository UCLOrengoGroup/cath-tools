...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_BOOST_ADDENDA_PTR_CONTAINER_UNIQUE_PTR_FUNCTIONS_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_BOOST_ADDENDA_PTR_CONTAINER_UNIQUE_PTR_FUNCTIONS_HPP
