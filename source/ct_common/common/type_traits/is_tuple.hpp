...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_TYPE_TRAITS_IS_TUPLE_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_TYPE_TRAITS_IS_TUPLE_HPP

#include "common/type_traits/is_template_of_type.hpp"
