...
#ifndef _CATH_TOOLS_SOURCE_CHOPPING_CHOPPING_FORMAT_DOMALL_CHOPPING_FORMAT_H
#define _CATH_TOOLS_SOURCE_CHOPPING_CHOPPING_FORMAT_DOMALL_CHOPPING_FORMAT_H
...
namespace cath {
	namespace chop {
		...
		public:
			virtual ~domall_chopping_format() noexcept = default;
		};
