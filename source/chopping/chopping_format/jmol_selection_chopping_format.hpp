...
#ifndef _CATH_TOOLS_SOURCE_CHOPPING_CHOPPING_FORMAT_JMOL_SELECTION_CHOPPING_FORMAT_H
#define _CATH_TOOLS_SOURCE_CHOPPING_CHOPPING_FORMAT_JMOL_SELECTION_CHOPPING_FORMAT_H
