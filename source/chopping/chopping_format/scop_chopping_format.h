...
#ifndef _CATH_TOOLS_SOURCE_CHOPPING_CHOPPING_FORMAT_SCOP_CHOPPING_FORMAT_H
#define _CATH_TOOLS_SOURCE_CHOPPING_CHOPPING_FORMAT_SCOP_CHOPPING_FORMAT_H
...
namespace cath {
	namespace chop {
		...
		public:
			virtual ~scop_chopping_format() noexcept = default;
		};
