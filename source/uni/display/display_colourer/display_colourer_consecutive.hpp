...
#ifndef _CATH_TOOLS_SOURCE_UNI_DISPLAY_DISPLAY_COLOURER_DISPLAY_COLOURER_CONSECUTIVE_H
#define _CATH_TOOLS_SOURCE_UNI_DISPLAY_DISPLAY_COLOURER_DISPLAY_COLOURER_CONSECUTIVE_H

#include "display/display_colourer/alignment_free_display_colourer.hpp"
