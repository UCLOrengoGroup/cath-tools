/// \file
/// \brief The display_colourer_score class definitions
...
#include "display_colourer_score.hpp"
...
unique_ptr<display_colourer> display_colourer_score::do_clone() const {
...
string display_colourer_score::do_get_label() const {
	return "Colour by alignbow";
}

/// \brief Get the gradient with which this display_colourer_score should colour alignments
const display_colour_gradient & display_colourer_score::get_gradient() const {
	return gradient;
}
