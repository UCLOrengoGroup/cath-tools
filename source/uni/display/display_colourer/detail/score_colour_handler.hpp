...
#ifndef _CATH_TOOLS_SOURCE_UNI_DISPLAY_DISPLAY_COLOURER_DETAIL_SCORE_COLOUR_HANDLER_H
#define _CATH_TOOLS_SOURCE_UNI_DISPLAY_DISPLAY_COLOURER_DETAIL_SCORE_COLOUR_HANDLER_H
