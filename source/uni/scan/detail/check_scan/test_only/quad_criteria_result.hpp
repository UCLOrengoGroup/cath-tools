...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_CHECK_SCAN_TEST_ONLY_QUAD_CRITERIA_RESULT_H
#define _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_CHECK_SCAN_TEST_ONLY_QUAD_CRITERIA_RESULT_H
