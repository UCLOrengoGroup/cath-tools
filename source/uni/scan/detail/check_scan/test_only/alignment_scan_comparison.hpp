...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_CHECK_SCAN_TEST_ONLY_ALIGNMENT_SCAN_COMPARISON_H
#define _CATH_TOOLS_SOURCE_UNI_SCAN_DETAIL_CHECK_SCAN_TEST_ONLY_ALIGNMENT_SCAN_COMPARISON_H
