...
#ifndef _CATH_TOOLS_SOURCE_UNI_SUPERPOSITION_OPTIONS_ALIGN_REGIONS_OPTIONS_BLOCK_H
#define _CATH_TOOLS_SOURCE_UNI_SUPERPOSITION_OPTIONS_ALIGN_REGIONS_OPTIONS_BLOCK_H
