...
#ifndef _CATH_TOOLS_SOURCE_UNI_ACQUIRER_PDBS_ACQUIRER_ISTREAM_PDBS_ACQUIRER_H
#define _CATH_TOOLS_SOURCE_UNI_ACQUIRER_PDBS_ACQUIRER_ISTREAM_PDBS_ACQUIRER_H
