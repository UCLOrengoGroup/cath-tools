...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_PAIR_SCATTER_PLOTTER_PAIR_SCATTER_PLOTTER_H
#define _CATH_TOOLS_SOURCE_UNI_SCORE_PAIR_SCATTER_PLOTTER_PAIR_SCATTER_PLOTTER_H
