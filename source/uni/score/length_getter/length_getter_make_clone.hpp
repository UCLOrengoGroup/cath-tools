...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_LENGTH_GETTER_MAKE_CLONE_HPP
#define _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_LENGTH_GETTER_MAKE_CLONE_HPP
