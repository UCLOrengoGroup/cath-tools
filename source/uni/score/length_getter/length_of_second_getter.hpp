...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_LENGTH_OF_SECOND_GETTER_H
#define _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_LENGTH_OF_SECOND_GETTER_H
