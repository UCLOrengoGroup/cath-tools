...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_SYM_PROTEIN_ONLY_LENGTH_GETTER_H
#define _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_SYM_PROTEIN_ONLY_LENGTH_GETTER_H
