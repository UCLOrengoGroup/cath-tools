...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_GEOMETRIC_MEAN_LENGTH_GETTER_H
#define _CATH_TOOLS_SOURCE_UNI_SCORE_LENGTH_GETTER_GEOMETRIC_MEAN_LENGTH_GETTER_H
