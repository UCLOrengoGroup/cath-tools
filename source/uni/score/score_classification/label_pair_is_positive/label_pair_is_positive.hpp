...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_SCORE_CLASSIFICATION_LABEL_PAIR_IS_POSITIVE_LABEL_PAIR_IS_POSITIVE_H
#define _CATH_TOOLS_SOURCE_UNI_SCORE_SCORE_CLASSIFICATION_LABEL_PAIR_IS_POSITIVE_LABEL_PAIR_IS_POSITIVE_H
