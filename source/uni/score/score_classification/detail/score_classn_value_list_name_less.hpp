...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_SCORE_CLASSIFICATION_DETAIL_SCORE_CLASSN_VALUE_LIST_NAME_LESS_H
#define _CATH_TOOLS_SOURCE_UNI_SCORE_SCORE_CLASSIFICATION_DETAIL_SCORE_CLASSN_VALUE_LIST_NAME_LESS_H
