...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_SCORE_CLASSIFICATION_VALUE_LIST_SCALING_H
#define _CATH_TOOLS_SOURCE_UNI_SCORE_SCORE_CLASSIFICATION_VALUE_LIST_SCALING_H
