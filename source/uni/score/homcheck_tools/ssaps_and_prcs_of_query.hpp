...
#ifndef _CATH_TOOLS_SOURCE_UNI_SCORE_HOMCHECK_TOOLS_SSAPS_AND_PRCS_OF_QUERY_H
#define _CATH_TOOLS_SOURCE_UNI_SCORE_HOMCHECK_TOOLS_SSAPS_AND_PRCS_OF_QUERY_H
