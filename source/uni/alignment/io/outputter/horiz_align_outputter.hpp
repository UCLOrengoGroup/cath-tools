...
#ifndef _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_IO_OUTPUTTER_HORIZ_ALIGN_OUTPUTTER_H
#define _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_IO_OUTPUTTER_HORIZ_ALIGN_OUTPUTTER_H
