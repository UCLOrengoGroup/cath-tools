...
#ifndef _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_REFINER_DETAIL_ALIGNMENT_SPLIT_LIST_H
#define _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_REFINER_DETAIL_ALIGNMENT_SPLIT_LIST_H
