...
#ifndef _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_COMMON_ATOM_SELECTION_POLICY_COMMON_ATOM_SELECT_CB_POLICY_H
#define _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_COMMON_ATOM_SELECTION_POLICY_COMMON_ATOM_SELECT_CB_POLICY_H
