...
#ifndef _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_DYN_PROG_ALIGN_STD_DYN_PROG_ALIGNER_H
#define _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_DYN_PROG_ALIGN_STD_DYN_PROG_ALIGNER_H
