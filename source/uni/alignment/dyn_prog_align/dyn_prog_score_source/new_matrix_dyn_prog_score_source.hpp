...
#ifndef _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_DYN_PROG_ALIGN_DYN_PROG_SCORE_SOURCE_NEW_MATRIX_DYN_PROG_SCORE_SOURCE_H
#define _CATH_TOOLS_SOURCE_UNI_ALIGNMENT_DYN_PROG_ALIGN_DYN_PROG_SCORE_SOURCE_NEW_MATRIX_DYN_PROG_SCORE_SOURCE_H
