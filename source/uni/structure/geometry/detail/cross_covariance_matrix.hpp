...
#ifndef _CATH_TOOLS_SOURCE_UNI_STRUCTURE_GEOMETRY_DETAIL_CROSS_COVARIANCE_MATRIX_HPP
#define _CATH_TOOLS_SOURCE_UNI_STRUCTURE_GEOMETRY_DETAIL_CROSS_COVARIANCE_MATRIX_HPP
