...
#ifndef _CATH_TOOLS_SOURCE_UNI_STRUCTURE_GEOMETRY_RESTRICT_TO_SINGLE_LINKAGE_EXTENSION_H
#define _CATH_TOOLS_SOURCE_UNI_STRUCTURE_GEOMETRY_RESTRICT_TO_SINGLE_LINKAGE_EXTENSION_H
