...
#ifndef _CATH_TOOLS_SOURCE_UNI_STRUCTURE_SEC_STRUC_CALC_DSSP_DSSP_SS_CALC_HPP
#define _CATH_TOOLS_SOURCE_UNI_STRUCTURE_SEC_STRUC_CALC_DSSP_DSSP_SS_CALC_HPP
