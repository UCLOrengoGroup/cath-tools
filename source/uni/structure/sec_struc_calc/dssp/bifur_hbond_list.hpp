...
#ifndef _CATH_TOOLS_SOURCE_UNI_STRUCTURE_SEC_STRUC_CALC_DSSP_BIFUR_HBOND_LIST_H
#define _CATH_TOOLS_SOURCE_UNI_STRUCTURE_SEC_STRUC_CALC_DSSP_BIFUR_HBOND_LIST_H
