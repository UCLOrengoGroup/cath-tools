...
#ifndef _CATH_TOOLS_SOURCE_UNI_STRUCTURE_VIEW_CACHE_INDEX_QUAD_FIND_ACTION_CHECK_H
#define _CATH_TOOLS_SOURCE_UNI_STRUCTURE_VIEW_CACHE_INDEX_QUAD_FIND_ACTION_CHECK_H
