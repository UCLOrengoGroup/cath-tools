...
#ifndef _CATH_TOOLS_SOURCE_UNI_STRUCTURE_VIEW_CACHE_INDEX_DETAIL_DIMS_VIEW_CACHE_INDEX_DIM_LINEAR_FROM_PSI_H
#define _CATH_TOOLS_SOURCE_UNI_STRUCTURE_VIEW_CACHE_INDEX_DETAIL_DIMS_VIEW_CACHE_INDEX_DIM_LINEAR_FROM_PSI_H
			...
			namespace detail {
				...
				struct vci_linear_view_from_psi_getter final {
					...
					auto operator()(const view_cache_index_entry &arg_entry ///< TODOCUMENT
					                )->decltype( arg_entry.get_from_psi_angle() ) {
						return arg_entry.get_from_psi_angle();
					}
