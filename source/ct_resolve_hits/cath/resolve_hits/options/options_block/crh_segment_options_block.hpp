...
#ifndef _CATH_TOOLS_SOURCE_RESOLVE_HITS_OPTIONS_OPTIONS_BLOCK_CRH_SEGMENT_OPTIONS_BLOCK_HPP
#define _CATH_TOOLS_SOURCE_RESOLVE_HITS_OPTIONS_OPTIONS_BLOCK_CRH_SEGMENT_OPTIONS_BLOCK_HPP
