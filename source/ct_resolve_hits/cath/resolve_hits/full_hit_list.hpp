...
#ifndef CATH_TOOLS_SOURCE_CT_RESOLVE_HITS_CATH_RESOLVE_HITS_FULL_HIT_LIST_HPP
#define CATH_TOOLS_SOURCE_CT_RESOLVE_HITS_CATH_RESOLVE_HITS_FULL_HIT_LIST_HPP
...
namespace cath::rslv {
	...
	std::ostream & operator<<(std::ostream &,
	                          const full_hit_list &);
	bool operator==(const full_hit_list &,
	                const full_hit_list &);
...
#endif // CATH_TOOLS_SOURCE_CT_RESOLVE_HITS_CATH_RESOLVE_HITS_FULL_HIT_LIST_HPP
