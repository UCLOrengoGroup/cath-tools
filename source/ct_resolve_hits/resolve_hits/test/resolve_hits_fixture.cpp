...
const string resolve_hits_fixture::example_input_raw = R"(qyikaz cath|current|2i24N00/2-114-i5_1,6.7e-18 2744.56644492722 8-108
...
const string resolve_hits_fixture::example_output = R"(# Generated by cath-resolve-hits vX.X.X-X-XXXXXXXX, one of the cath-tools (https://github.com/UCLOrengoGroup/cath-tools)
