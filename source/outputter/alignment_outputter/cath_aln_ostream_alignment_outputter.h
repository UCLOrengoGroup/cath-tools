...
#ifndef _CATH_TOOLS_SOURCE_OUTPUTTER_ALIGNMENT_OUTPUTTER_CATH_ALN_OSTREAM_ALIGNMENT_OUTPUTTER_H
#define _CATH_TOOLS_SOURCE_OUTPUTTER_ALIGNMENT_OUTPUTTER_CATH_ALN_OSTREAM_ALIGNMENT_OUTPUTTER_H
...
namespace cath {
	namespace opts {
		...
		public:
			virtual ~cath_aln_ostream_alignment_outputter() noexcept = default;
		};
