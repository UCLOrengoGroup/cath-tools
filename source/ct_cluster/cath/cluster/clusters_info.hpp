...
#ifndef _CATH_TOOLS_SOURCE_CT_CLUSTER_CATH_CLUSTER_CLUSTERS_INFO_HPP
#define _CATH_TOOLS_SOURCE_CT_CLUSTER_CATH_CLUSTER_CLUSTERS_INFO_HPP
...
namespace cath::clust {
	...
	public:
		...
		cluster_id_t add_name(const ::std::string_view &);
	...
	inline cluster_id_t clusters_info::add_name(const ::std::string_view &prm_name ///< The name of the cluster to add
	                                            ) {
	...
	inline clusters_info & clusters_info::update_info_for_cluster_of_id(const cluster_id_t         &prm_cluster_id, ///< The ID of the cluster to increment the size of
	                                                                    const ::std::string_view   &prm_name,       ///< The name of the new entry in the cluster
	...
	inline cluster_id_t update_info_and_get_id_for_cluster_of_name(clusters_info              &prm_clusters_info, ///< The clusters_info to query
	                                                               const ::std::string_view   &prm_cluster_name,  ///< The name of the cluster of interest
	                                                               const ::std::string_view   &prm_entry_name,    ///< The name of the entry of interest
...
#endif // _CATH_TOOLS_SOURCE_CT_CLUSTER_CATH_CLUSTER_CLUSTERS_INFO_HPP
