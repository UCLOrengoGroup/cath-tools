...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_CLONE_CHECK_UPTR_CLONE_AGAINST_THIS_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_CLONE_CHECK_UPTR_CLONE_AGAINST_THIS_H
