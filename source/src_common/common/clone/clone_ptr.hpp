...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_CLONE_CLONE_PTR_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_CLONE_CLONE_PTR_HPP
...
#include "common/clone/detail/is_cloneable.hpp"
