...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_CPP20_MAKE_ARRAY_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_CPP20_MAKE_ARRAY_HPP

#include "common/cpp17/conjunction.hpp"
#include "common/cpp17/negation.hpp"
