...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_EXCEPTION_EXCEPTION_IS_EQUIVALENT_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_EXCEPTION_EXCEPTION_IS_EQUIVALENT_H
