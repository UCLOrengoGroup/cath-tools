...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_METAPROGRAMMING_APPEND_TEMPLATE_PARAMS_INTO_FIRST_WRAPPER_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_METAPROGRAMMING_APPEND_TEMPLATE_PARAMS_INTO_FIRST_WRAPPER_H
