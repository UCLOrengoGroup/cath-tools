...
#ifndef _CATH_TOOLS_SOURCE_COMMON_METAPROGRAMMING_CHANGE_TEMPLATE_SUBWRAPPERS_H
#define _CATH_TOOLS_SOURCE_COMMON_METAPROGRAMMING_CHANGE_TEMPLATE_SUBWRAPPERS_H
