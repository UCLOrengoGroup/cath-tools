...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_CHRONO_DURATION_TO_SECONDS_STRING_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_CHRONO_DURATION_TO_SECONDS_STRING_HPP
