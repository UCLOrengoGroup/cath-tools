...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_ALGORITHM_ADJACENT_ACCUMULATE_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_ALGORITHM_ADJACENT_ACCUMULATE_H
