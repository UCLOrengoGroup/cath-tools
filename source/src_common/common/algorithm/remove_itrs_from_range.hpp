...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_ALGORITHM_REMOVE_ITRS_FROM_RANGE_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_ALGORITHM_REMOVE_ITRS_FROM_RANGE_H
