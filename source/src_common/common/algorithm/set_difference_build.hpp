...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_ALGORITHM_SET_DIFFERENCE_BUILD_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_ALGORITHM_SET_DIFFERENCE_BUILD_H
