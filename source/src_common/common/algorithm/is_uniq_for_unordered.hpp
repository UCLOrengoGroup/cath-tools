...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_ALGORITHM_IS_UNIQ_FOR_UNORDERED_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_ALGORITHM_IS_UNIQ_FOR_UNORDERED_H
