...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_POLYMORPHIC_COMPARISON_POLYMORPHIC_EQUALITY_COMPARABLE_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_POLYMORPHIC_COMPARISON_POLYMORPHIC_EQUALITY_COMPARABLE_H
