...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_POLYMORPHIC_COMPARISON_DETAIL_IS_EQUAL_WITH_SAME_DYNAMIC_TYPE_COMPARABLE_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_POLYMORPHIC_COMPARISON_DETAIL_IS_EQUAL_WITH_SAME_DYNAMIC_TYPE_COMPARABLE_HPP
	...
	namespace common {
		namespace detail {
			...
			public:
				...
				is_equal_with_same_dynamic_type_comparable(const X &arg_value_1,
				                                           const X &arg_value_2
				                                           ) : value_1(arg_value_1),
				                                               value_2(arg_value_2) {
				}
