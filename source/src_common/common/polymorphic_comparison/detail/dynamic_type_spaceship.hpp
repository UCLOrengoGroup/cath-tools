...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_POLYMORPHIC_COMPARISON_DETAIL_DYNAMIC_TYPE_SPACESHIP_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_POLYMORPHIC_COMPARISON_DETAIL_DYNAMIC_TYPE_SPACESHIP_H
