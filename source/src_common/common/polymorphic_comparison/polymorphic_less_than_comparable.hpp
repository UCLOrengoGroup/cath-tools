...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_POLYMORPHIC_COMPARISON_POLYMORPHIC_LESS_THAN_COMPARABLE_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_POLYMORPHIC_COMPARISON_POLYMORPHIC_LESS_THAN_COMPARABLE_H

#include <boost/concept/assert.hpp>
#include <boost/serialization/nvp.hpp>

#include "common/polymorphic_comparison/detail/dynamic_type_spaceship.hpp"
#include "common/polymorphic_comparison/detail/is_less_than_with_same_dynamic_type_comparable.hpp"
