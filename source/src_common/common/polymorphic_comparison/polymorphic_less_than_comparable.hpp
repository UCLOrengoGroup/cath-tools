...
#ifndef _CATH_TOOLS_SOURCE_COMMON_POLYMORPHIC_COMPARISON_POLYMORPHIC_LESS_THAN_COMPARABLE_H
#define _CATH_TOOLS_SOURCE_COMMON_POLYMORPHIC_COMPARISON_POLYMORPHIC_LESS_THAN_COMPARABLE_H
