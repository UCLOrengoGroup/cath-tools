...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_PROGRAM_OPTIONS_PROG_OPT_NUM_RANGE_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_PROGRAM_OPTIONS_PROG_OPT_NUM_RANGE_HPP
