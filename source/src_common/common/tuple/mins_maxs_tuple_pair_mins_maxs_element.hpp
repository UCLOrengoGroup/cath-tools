...
#ifndef _CATH_TOOLS_SOURCE_COMMON_TUPLE_MINS_MAXS_TUPLE_PAIR_MINS_MAXS_ELEMENT_H
#define _CATH_TOOLS_SOURCE_COMMON_TUPLE_MINS_MAXS_TUPLE_PAIR_MINS_MAXS_ELEMENT_H
