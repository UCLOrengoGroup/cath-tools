...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_PROPERTY_TREE_MAKE_PTREE_OF_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_PROPERTY_TREE_MAKE_PTREE_OF_HPP
