...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_DETAIL_TUPLE_INDEX_SEQUENCE_HPP
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_DETAIL_TUPLE_INDEX_SEQUENCE_HPP
