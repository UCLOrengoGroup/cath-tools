...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_BOOST_ADDENDA_LEXICAL_CAST_STRINGSTREAM_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_BOOST_ADDENDA_LEXICAL_CAST_STRINGSTREAM_H
