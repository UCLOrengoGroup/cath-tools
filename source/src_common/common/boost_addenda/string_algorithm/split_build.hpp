...
#ifndef _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_BOOST_ADDENDA_STRING_ALGORITHM_SPLIT_BUILD_H
#define _CATH_TOOLS_SOURCE_SRC_COMMON_COMMON_BOOST_ADDENDA_STRING_ALGORITHM_SPLIT_BUILD_H
