...
#ifndef _CATH_TOOLS_SOURCE_COMMON_BOOST_ADDENDA_FILESYSTEM_REPLACE_EXTENSION_COPY_H
#define _CATH_TOOLS_SOURCE_COMMON_BOOST_ADDENDA_FILESYSTEM_REPLACE_EXTENSION_COPY_H
