...
#ifndef _CATH_TOOLS_SOURCE_COMMON_BOOST_ADDENDA_PROGRAM_OPTIONS_SET_OPT_STR_FROM_PROG_OPTS_TRY_H
#define _CATH_TOOLS_SOURCE_COMMON_BOOST_ADDENDA_PROGRAM_OPTIONS_SET_OPT_STR_FROM_PROG_OPTS_TRY_H
