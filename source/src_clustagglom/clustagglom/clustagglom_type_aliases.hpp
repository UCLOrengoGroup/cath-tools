...
#ifndef _CATH_TOOLS_SOURCE_SRC_CLUSTAGGLOM_CLUSTAGGLOM_CLUSTAGGLOM_TYPE_ALIASES_H
#define _CATH_TOOLS_SOURCE_SRC_CLUSTAGGLOM_CLUSTAGGLOM_CLUSTAGGLOM_TYPE_ALIASES_H
