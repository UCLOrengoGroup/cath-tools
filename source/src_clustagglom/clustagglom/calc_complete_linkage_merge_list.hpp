...
#ifndef _CATH_TOOLS_SOURCE_CLUSTER_AGGLOM_CALC_COMPLETE_LINKAGE_MERGE_LIST_H
#define _CATH_TOOLS_SOURCE_CLUSTER_AGGLOM_CALC_COMPLETE_LINKAGE_MERGE_LIST_H
