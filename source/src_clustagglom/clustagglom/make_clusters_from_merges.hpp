...
#ifndef _CATH_TOOLS_SOURCE_SRC_CLUSTAGGLOM_CLUSTAGGLOM_MAKE_CLUSTERS_FROM_MERGES_H
#define _CATH_TOOLS_SOURCE_SRC_CLUSTAGGLOM_CLUSTAGGLOM_MAKE_CLUSTERS_FROM_MERGES_H
