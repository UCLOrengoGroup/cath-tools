...
#ifndef _CATH_TOOLS_SOURCE_SRC_CLUSTAGGLOM_CLUSTAGGLOM_CALC_COMPLETE_LINKAGE_MERGE_LIST_HPP
#define _CATH_TOOLS_SOURCE_SRC_CLUSTAGGLOM_CLUSTAGGLOM_CALC_COMPLETE_LINKAGE_MERGE_LIST_HPP
