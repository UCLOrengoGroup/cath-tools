...
#ifndef _CATH_TOOLS_SOURCE_CT_CLUSTAGGLOM_CATH_CLUSTAGGLOM_CALC_COMPLETE_LINKAGE_MERGE_LIST_HPP
#define _CATH_TOOLS_SOURCE_CT_CLUSTAGGLOM_CATH_CLUSTAGGLOM_CALC_COMPLETE_LINKAGE_MERGE_LIST_HPP
