...
#ifndef _CATH_TOOLS_SOURCE_CLUSTER_OPTIONS_OPTIONS_BLOCK_CLUST_MAPPING_OPTIONS_BLOCK_H
#define _CATH_TOOLS_SOURCE_CLUSTER_OPTIONS_OPTIONS_BLOCK_CLUST_MAPPING_OPTIONS_BLOCK_H
