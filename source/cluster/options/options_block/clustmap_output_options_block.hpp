...
#ifndef _CATH_TOOLS_SOURCE_CLUSTER_OPTIONS_OPTIONS_BLOCK_CLUSTMAP_OUTPUT_OPTIONS_BLOCK_HPP
#define _CATH_TOOLS_SOURCE_CLUSTER_OPTIONS_OPTIONS_BLOCK_CLUSTMAP_OUTPUT_OPTIONS_BLOCK_HPP

#include "cluster/options/spec/clustmap_output_spec.hpp"
