...
#ifndef _CATH_TOOLS_SOURCE_CLUSTER_OPTIONS_OPTIONS_BLOCK_CLUSTMAP_OUTPUT_OPTIONS_BLOCK_H
#define _CATH_TOOLS_SOURCE_CLUSTER_OPTIONS_OPTIONS_BLOCK_CLUSTMAP_OUTPUT_OPTIONS_BLOCK_H
