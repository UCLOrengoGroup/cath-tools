...
#ifndef _CATH_TOOLS_SOURCE_CLUSTER_OPTIONS_OPTIONS_BLOCK_CLUSTMAP_INPUT_OPTIONS_BLOCK_HPP
#define _CATH_TOOLS_SOURCE_CLUSTER_OPTIONS_OPTIONS_BLOCK_CLUSTMAP_INPUT_OPTIONS_BLOCK_HPP
