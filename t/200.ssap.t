...
my @tests = (
	...
	[ '3fxhA00', '3g1jA00', 'New problem: throws error exception',                          '--supdir', '.' ], # "std::exception::what: Unable to get pdb_name_number() from residues selected by policy" from /export/svnbuild/trunk/tempBuildDir/cath_binaries/trunk/source/alignment/alignment_coord_extractor.cpp(95): Throw in function static std::pair<cath::coord_list, cath::coord_list> cath::alignment_coord_extractor::get_common_coords(const cath::alignment&, const cath::protein&, const cath::protein&, const unsigned int&, const int (*)[5000], const cath::common_coord_selection_policy&, const unsigned int&, const unsigned int&)
	[ '3g1jA00', '3nrgA00', 'New problem: throws error exception',                          '--supdir', '.' ], # "std::exception::what: Unable to get pdb_name_number() from residues selected by policy" from /export/svnbuild/trunk/tempBuildDir/cath_binaries/trunk/source/alignment/alignment_coord_extractor.cpp(95): Throw in function static std::pair<cath::coord_list, cath::coord_list> cath::alignment_coord_extractor::get_common_coords(const cath::alignment&, const cath::protein&, const cath::protein&, const unsigned int&, const int (*)[5000], const cath::common_coord_selection_policy&, const unsigned int&, const unsigned int&)
